<?php
    ...
    class RouterGroup{
        ...
        /**
         * @var RouterGroup[] The groups contained by this group
         */
        private $groups = [];
         ...
         */
        public function __construct($group = '', $lazyPath = NULL, $lazyVariable = 'group'){
         ...
         * @param string $lazyVariable The name of the variable, where the group can be accessed in the $lazyPath
         * 
         * @return RouterGroup The created or existing router group
         */
        public function group($group, $lazyPath = NULL, $lazyVariable = 'group'){
            if(!isset($this->groups[$group])){
                $this->groups[$group] = new RouterGroup($group, $lazyPath, $lazyVariable);
            }
